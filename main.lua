...
include("scripts.menus.profileSubmenu")
include("scripts.menus.corpseRaiserSubmenu")
include("scripts.menus.customSFXSubmenu")
include("scripts.menus.weaponsmithSubmenu")
...
PSTAVessel:AddCallback(ModCallbacks.MC_POST_SAVESLOT_LOAD, PSTAVessel.onSaveSlot)
