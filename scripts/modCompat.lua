...
function PSTAVessel:initModCompat()
    ...
    if Epiphany then
        ...
        PSTAVessel_addEpItem("SEGMENTATION_FAULT", {PSTAVConstellationType.OCCULT})
        ...
        PSTAVessel_addEpItem("GLITCH_ITEM_0", {PSTAVConstellationType.OCCULT})
        PSTAVessel_addEpItem("GLITCH_ITEM_1", {PSTAVConstellationType.OCCULT})
        PSTAVessel_addEpItem("GLITCH_ITEM_2", {PSTAVConstellationType.OCCULT})
        PSTAVessel_addEpItem("GLITCH_ITEM_3", {PSTAVConstellationType.OCCULT})
    ...
    if ReverieMGO then
        ...
        PSTAVessel_addRevItem("[Load Failure]", {PSTAVConstellationType.MUNDANE})
