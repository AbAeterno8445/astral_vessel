...
function PSTAVessel:initModCompat()
    ...
    if FiendFolio then
        ...
        -- table.insert(PSTAVessel.facesList, {path="gfx/characters/chirumiru.anm2", sourceMod="Fiend Folio"})
        -- table.insert(PSTAVessel.facesList, {path="gfx/characters/ff_double_dog.anm2", sourceMod="Fiend Folio"})
        -- table.insert(PSTAVessel.facesList, {path="gfx/characters/ff_spirit_of_nightmare.anm2", sourceMod="Fiend Folio"})
        -- table.insert(PSTAVessel.facesList, {path="gfx/characters/ff_hyperfixation.anm2", sourceMod="Fiend Folio"})
        -- table.insert(PSTAVessel.facesList, {path="gfx/characters/ff_deal_of_the_demons.anm2", sourceMod="Fiend Folio"})
        -- table.insert(PSTAVessel.facesList, {path="gfx/characters/clownmeat.anm2", sourceMod="Fiend Folio"})
		...
		table.insert(PSTAVessel.accessoryList, {path="gfx/characters/fetal_friend.anm2", sourceMod="Fiend Folio"})
		...
		table.insert(PSTAVessel.hairstyles, {path="gfx/characters/ff_pak_choi.anm2", sourceMod="Fiend Folio"})
		table.insert(PSTAVessel.hairstyles, {path="gfx/characters/100_orangejuice.anm2", sourceMod="Fiend Folio"})
        ...
        PSTAVessel_addFFItem("ANATHEMA", {PSTAVConstellationType.DIVINE})
        PSTAVessel_addFFItem("WARFARIN", {PSTAVConstellationType.MUTAGENIC})
        PSTAVessel_addFFItem("MTN_DEW", {PSTAVConstellationType.MUTAGENIC, PSTAVConstellationType.MUNDANE})
        PSTAVessel_addFFItem("GRANDPAS_WHISKEY", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addFFItem("SHOCK_IMAGE", {PSTAVConstellationType.MUNDANE, PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addFFItem("STRING_THEORY", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addFFItem("HUNDRED_PERCENT_ORANGE_JUICE", {PSTAVConstellationType.MUNDANE, PSTAVConstellationType.MERCANTILE})
        PSTAVessel_addFFItem("BOMB_COLLAR", {PSTAVConstellationType.DEMONIC})
        PSTAVessel_addFFItem("INFESTATION_3", {PSTAVConstellationType.MUTAGENIC})
        PSTAVessel_addFFItem("INFESTATION_4", {PSTAVConstellationType.MUTAGENIC})
        PSTAVessel_addFFItem("UTILITY_POLE", {PSTAVConstellationType.MUNDANE, PSTAVConstellationType.MERCANTILE})
        PSTAVessel_addFFItem("STRANGE_MATTER", {PSTAVConstellationType.MUTAGENIC})
        PSTAVessel_addFFItem("LIL_FRIEND", {PSTAVConstellationType.DEMONIC})
        PSTAVessel_addFFItem("ANTISAAC", {PSTAVConstellationType.OCCULT, PSTAVConstellationType.COSMIC})
        PSTAVessel_addFFItem("TRICOLOR_KEY", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addFFItem("D5", {PSTAVConstellationType.MERCANTILE})
        PSTAVessel_addFFItem("SPINACH_PIE", {PSTAVConstellationType.MUNDANE, PSTAVConstellationType.MUTAGENIC})
        ...
        PSTAVessel_addFFItem("SPEED_MODULE", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addFFItem("PRODUCTIVITY_MODULE", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addFFItem("DEFAULT_DOG", {PSTAVConstellationType.MUTAGENIC, PSTAVConstellationType.MUNDANE})
        PSTAVessel_addFFItem("DIVINE_DOG", {PSTAVConstellationType.MUTAGENIC, PSTAVConstellationType.DIVINE})
        PSTAVessel_addFFItem("DEVIL_DOG", {PSTAVConstellationType.MUTAGENIC, PSTAVConstellationType.DEMONIC})
        PSTAVessel_addFFItem("DEAD_DOG", {PSTAVConstellationType.MUTAGENIC, PSTAVConstellationType.OCCULT})
        PSTAVessel_addFFItem("DISCOUNT_DOG", {PSTAVConstellationType.MUTAGENIC, PSTAVConstellationType.MERCANTILE})
        PSTAVessel_addFFItem("DESTINED_DOG", {PSTAVConstellationType.MUTAGENIC, PSTAVConstellationType.COSMIC})
        PSTAVessel_addFFItem("DWARF_DOG", {PSTAVConstellationType.MUTAGENIC, PSTAVConstellationType.COSMIC})
        PSTAVessel_addFFItem("DEWEY_DECIMAL_DOG", {PSTAVConstellationType.MUTAGENIC, PSTAVConstellationType.MUNDANE})
        PSTAVessel_addFFItem("DAUNTING_DOG", {PSTAVConstellationType.MUTAGENIC, PSTAVConstellationType.MUNDANE})
        PSTAVessel_addFFItem("DOG_DOG_DOG_DOG", {PSTAVConstellationType.MUTAGENIC, PSTAVConstellationType.COSMIC})
        PSTAVessel_addFFItem("KALU", {PSTAVConstellationType.MUTAGENIC, PSTAVConstellationType.OCCULT})
        PSTAVessel_addFFItem("FABERGE_BOMBS", {PSTAVConstellationType.MERCANTILE})
        PSTAVessel_addFFItem("FRIENDS_FIREBALL_FORMULA", {PSTAVConstellationType.ELEMENTAL, PSTAVConstellationType.DEMONIC})
        PSTAVessel_addFFItem("SWEET_RED", {PSTAVConstellationType.ELEMENTAL, PSTAVConstellationType.MUTAGENIC})
        PSTAVessel_addFFItem("DRIED_PAINT", {PSTAVConstellationType.OCCULT})
        PSTAVessel_addFFItem("EMPTY_GAZE", {PSTAVConstellationType.MUTAGENIC})
        PSTAVessel_addFFItem("HUITLACOCHE", {PSTAVConstellationType.MUTAGENIC, PSTAVConstellationType.DEMONIC})
        PSTAVessel_addFFItem("CHAOTIC_CARVING", {PSTAVConstellationType.OCCULT})
        PSTAVessel_addFFItem("CLOWN_MEAT", {PSTAVConstellationType.MUTAGENIC, PSTAVConstellationType.DEMONIC})
        PSTAVessel_addFFItem("IMP_CURSE", {PSTAVConstellationType.DEMONIC})
        PSTAVessel_addFFItem("CHEMICAL_COOKIE", {PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addFFItem("SPIRIT_OF_NIGHTMARE", {PSTAVConstellationType.OCCULT})
        PSTAVessel_addFFItem("DAYDREAM", {PSTAVConstellationType.COSMIC, PSTAVConstellationType.MUNDANE})
        PSTAVessel_addFFItem("ZIP_43", {PSTAVConstellationType.COSMIC})
        PSTAVessel_addFFItem("FETAL_FRIEND", {PSTAVConstellationType.DEMONIC})
        PSTAVessel_addFFItem("IMP_SODA_TRICKY_CHERRY", {PSTAVConstellationType.OCCULT, PSTAVConstellationType.ELEMENTAL, PSTAVConstellationType.MUNDANE})
        PSTAVessel_addFFItem("SHUFFLE_TIME", {PSTAVConstellationType.MERCANTILE})
        PSTAVessel_addFFItem("EIGHTEEN_FOOT_LEASH", {PSTAVConstellationType.MUTAGENIC})
        PSTAVessel_addFFItem("WARDENS_CROWN", {PSTAVConstellationType.DIVINE})
        PSTAVessel_addFFItem("PAK_CHOI", {PSTAVConstellationType.MUNDANE}, 1.35) -- note: check to see if i can do decimal costs, so i can multiply its cost by 1.09
        PSTAVessel_addFFItem("SHUFFLE_BOMBS", {PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addFFItem("BULLET_HELL", {PSTAVConstellationType.ELEMENTAL, PSTAVConstellationType.OCCULT})
        PSTAVessel_addFFItem("GUPPYS_HEART", {PSTAVConstellationType.MUTAGENIC, PSTAVConstellationType.OCCULT})
        PSTAVessel_addFFItem("RAILDRIVER", {PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addFFItem("QUEENS_FRUIT", {PSTAVConstellationType.MUTAGENIC})
        PSTAVessel_addFFItem("STRANGE_EYE", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addFFItem("SNAGS", {PSTAVConstellationType.MERCANTILE})
        PSTAVessel_addFFItem("EXECUTIONER", {PSTAVConstellationType.OCCULT})
        PSTAVessel_addFFItem("GIZMO_BOOTS", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addFFItem("PLASMA_BALL", {PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addFFItem("LOURDES_WATER", {PSTAVConstellationType.DIVINE})
        PSTAVessel_addFFItem("DEVI", {PSTAVConstellationType.DIVINE})
        PSTAVessel_addFFItem("DOUBLES", {PSTAVConstellationType.MERCANTILE})
        PSTAVessel_addFFItem("DISCIPLINE", {PSTAVConstellationType.DIVINE})
        PSTAVessel_addFFItem("EYE_OF_PROVIDENCE", {PSTAVConstellationType.DIVINE, PSTAVConstellationType.OCCULT})
        PSTAVessel_addFFItem("ZERO_POINT_REACTOR", {PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addFFItem("GANYMEDE", {PSTAVConstellationType.COSMIC})
        PSTAVessel_addFFItem("HELLFIRE", {PSTAVConstellationType.DEMONIC})
        PSTAVessel_addFFItem("CHERUB_CHUBBY", {PSTAVConstellationType.DIVINE, PSTAVConstellationType.MUTAGENIC})
        PSTAVessel_addFFItem("CARELESS_WHISPERS", {PSTAVConstellationType.OCCULT})
        PSTAVessel_addFFItem("DARK_BARGAIN", {PSTAVConstellationType.DEMONIC})
        PSTAVessel_addFFItem("APOTHEOSIS", {PSTAVConstellationType.DIVINE})
        PSTAVessel_addFFItem("SUN_CROSS", {PSTAVConstellationType.DIVINE, PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addFFItem("STARDUST", {PSTAVConstellationType.COSMIC})
        PSTAVessel_addFFItem("TOWER_OF_HEAVEN", {PSTAVConstellationType.DIVINE})
        PSTAVessel_addFFItem("RED_NIGHTMARE", {PSTAVConstellationType.COSMIC, PSTAVConstellationType.OCCULT})
        PSTAVessel_addFFItem("GOLDEN_WATCH", {PSTAVConstellationType.MERCANTILE})
        PSTAVessel_addFFItem("ACHERON", {PSTAVConstellationType.DEMONIC})
        PSTAVessel_addFFItem("AIR_FRESHENER", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addFFItem("PLANET_X", {PSTAVConstellationType.COSMIC})
        PSTAVessel_addFFItem("GKUNHOMDIMA", {PSTAVConstellationType.COSMIC, PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addFFItem("GLITCHCITY", {PSTAVConstellationType.COSMIC})
        PSTAVessel_addFFItem("GOLDEN_SPIKES", {PSTAVConstellationType.MERCANTILE})
        PSTAVessel_addFFItem("PLANCHETTE", {PSTAVConstellationType.OCCULT})
        PSTAVessel_addFFItem("OUTLET_BABY", {PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addFFItem("PAPAL_PAL", {PSTAVConstellationType.DIVINE})
        PSTAVessel_addFFItem("BURGLAR_BABY", {PSTAVConstellationType.MERCANTILE})
        PSTAVessel_addFFItem("CYBORG_BABY", {PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addFFItem("MOTOR_SPIRIT", {PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addFFItem("NAGA_VIPER", {PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addFFItem("CREATION_OF_MAN", {PSTAVConstellationType.DIVINE})
        PSTAVessel_addFFItem("GREEN_APPLE", {PSTAVConstellationType.MUNDANE})
        ...
        PSTAVessel_addFFItem("DARKNESS", {PSTAVConstellationType.DEMONIC, PSTAVConstellationType.OCCULT})
        PSTAVessel_addFFItem("BRILLIANCE", {PSTAVConstellationType.DIVINE, PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addFFItem("RADIANCE", {PSTAVConstellationType.DIVINE, PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addFFItem("CROSS_NECKLACE", {PSTAVConstellationType.DIVINE})
        PSTAVessel_addFFItem("MARK_OF_PAIN", {PSTAVConstellationType.OCCULT})
        PSTAVessel_addFFItem("APPENDIX", {PSTAVConstellationType.MUTAGENIC})
        PSTAVessel_addFFItem("BAD_DATA", {PSTAVConstellationType.COSMIC})
        PSTAVessel_addFFItem("PARALLEL_BOMBS", {PSTAVConstellationType.COSMIC})
        PSTAVessel_addFFItem("PLATINUM_CREST", {PSTAVConstellationType.DIVINE})
        PSTAVessel_addFFItem("SOAPSUDS", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addFFItem("MAGIC_BULLET", {PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addFFItem("CRY_BABY", {PSTAVConstellationType.MUNDANE, PSTAVConstellationType.MUTAGENIC})
        PSTAVessel_addFFItem("PARANOIA", {PSTAVConstellationType.OCCULT})
        PSTAVessel_addFFItem("PHOENIX_ELIXIR", {PSTAVConstellationType.DIVINE, PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addFFItem("BEREAVEMENT", {PSTAVConstellationType.OCCULT})
        PSTAVessel_addFFItem("ISOLATED", {PSTAVConstellationType.OCCULT})
        PSTAVessel_addFFItem("ACUPUNCTURE_NEEDLES", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addFFItem("BOUNDLESS_PARASOL", {PSTAVConstellationType.OCCULT, PSTAVConstellationType.COSMIC})
        PSTAVessel_addFFItem("HYPERFIXATION", {PSTAVConstellationType.MUTAGENIC})
        PSTAVessel_addFFItem("HARE_TRIGGER", {PSTAVConstellationType.MUTAGENIC})
        PSTAVessel_addFFItem("REPRESSION", {PSTAVConstellationType.OCCULT})
        PSTAVessel_addFFItem("DUMB_BUNNY", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addFFItem("RABBITS_FOOT", {PSTAVConstellationType.OCCULT})
        PSTAVessel_addFFItem("GREEN_BOMBS", {PSTAVConstellationType.OCCULT})
        PSTAVessel_addFFItem("CRUSHING_ANXIETY", {PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addFFItem("THE_HAPPY_GO_LUCKY_ONION", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addFFItem("SOUL_EXTRACTION_BUM", {PSTAVConstellationType.DEMONIC})
        PSTAVessel_addFFItem("LIL_INABA", {PSTAVConstellationType.OCCULT, PSTAVConstellationType.COSMIC})
        PSTAVessel_addFFItem("DEAL_OF_THE_DEMONS", {PSTAVConstellationType.DEMONIC})
        ...
        PSTAVessel_addFFItem("STEVENS_HAT", {PSTAVConstellationType.MUNDANE, PSTAVConstellationType.COSMIC})
        PSTAVessel_addFFItem("MINESWEEPER", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addFFItem("ICE_IX", {PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addFFItem("SEVEN_SEALS_2", {PSTAVConstellationType.DIVINE, PSTAVConstellationType.DEMONIC})
        PSTAVessel_addFFItem("PALINOPSIA", {PSTAVConstellationType.MUTAGENIC})
        PSTAVessel_addFFItem("COPPER_WRENCH", {PSTAVConstellationType.MUNDANE})
        ...
        PSTAVessel_addFFItem("HOW_TO_ROLL", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addFFItem("FLIP_PHONE", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addFFItem("GAPER_IN_A_JAR", {PSTAVConstellationType.MUTAGENIC})
        PSTAVessel_addFFItem("GREEN_CANDLE", {PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addFFItem("DOG_WHISTLE", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addFFItem("DOOMSDAY_CLOCK", {PSTAVConstellationType.MUNDANE, PSTAVConstellationType.OCCULT, PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addFFItem("HOT_SHOT", {PSTAVConstellationType.ELEMENTAL, PSTAVConstellationType.DEMONIC})
        PSTAVessel_addFFItem("TELEPORT_ALPHA", {PSTAVConstellationType.COSMIC})
        PSTAVessel_addFFItem("HUMAN_DOMESTICATION_GUIDE", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addFFItem("THE_WAR_HORN", {PSTAVConstellationType.DEMONIC})
        PSTAVessel_addFFItem("DYNAMITE_PACK", {PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addFFItem("VOYAGER_VENDOR", {PSTAVConstellationType.MERCANTILE})
        PSTAVessel_addFFItem("GRANDPAS_GATLING_GUN", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addFFItem("SHADOW_CLUSTER", {PSTAVConstellationType.DEMONIC})
        PSTAVessel_addFFItem("DECK_BOX", {PSTAVConstellationType.MERCANTILE})
        PSTAVessel_addFFItem("STORY_OF_UNDERTALE", {PSTAVConstellationType.OCCULT})
        PSTAVessel_addFFItem("HOT_POTATO_BOOK", {PSTAVConstellationType.MUNDANE, PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addFFItem("ACTIVATED_CHARCOAL", {PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addFFItem("RESURRECTION", {PSTAVConstellationType.DIVINE, PSTAVConstellationType.OCCULT})
        PSTAVessel_addFFItem("EDENS_HEAD", {PSTAVConstellationType.COSMIC})
        PSTAVessel_addFFItem("SOLAR_TABLET", {PSTAVConstellationType.ELEMENTAL, PSTAVConstellationType.OCCULT})
        PSTAVessel_addFFItem("OLD_TESTAMENT", {PSTAVConstellationType.DIVINE})
        PSTAVessel_addFFItem("BOTTLE_CAP", {PSTAVConstellationType.OCCULT, PSTAVConstellationType.MUNDANE, PSTAVConstellationType.MERCANTILE})
        PSTAVessel_addFFItem("BOOK_OF_LEVIATHAN", {PSTAVConstellationType.OCCULT})
        PSTAVessel_addFFItem("THE_PYX", {PSTAVConstellationType.DIVINE})
        PSTAVessel_addFFItem("HOLY_BEAN", {PSTAVConstellationType.DIVINE, PSTAVConstellationType.MUTAGENIC})
        PSTAVessel_addFFItem("BLACK_EYED_PEA", {PSTAVConstellationType.MUTAGENIC})
        PSTAVessel_addFFItem("ECHOLILAC", {PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addFFItem("SNOOZE_BUTTON", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addFFItem("LASER_POINTER", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addFFItem("ANARCHISTS_EASY_BAKE", {PSTAVConstellationType.MUNDANE, PSTAVConstellationType.DEMONIC})
        PSTAVessel_addFFItem("SERTRALINE", {PSTAVConstellationType.MUTAGENIC, PSTAVConstellationType.OCCULT})
        ...
        PSTAVessel_addFFItem("DSTOCK", {PSTAVConstellationType.MERCANTILE})
        PSTAVessel_addFFItem("CLOWN_HORN", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addFFItem("PENNY_ALBUM", {PSTAVConstellationType.MERCANTILE})
        PSTAVessel_addFFItem("FIND_IT", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addFFItem("KALUS_WICKED_PAW", {PSTAVConstellationType.OCCULT, PSTAVConstellationType.MUTAGENIC})
        PSTAVessel_addFFItem("KNIFE_BLOCK", {PSTAVConstellationType.MUNDANE, PSTAVConstellationType.OCCULT})
        ...
        table.insert(PSTAVessel.batteryItems, FiendFolio.ITEM.COLLECTIBLE.EFFICIENCY_MODULE)
        table.insert(PSTAVessel.batteryItems, FiendFolio.ITEM.COLLECTIBLE.PRODUCTIVITY_MODULE)
        table.insert(PSTAVessel.batteryItems, FiendFolio.ITEM.COLLECTIBLE.SPEED_MODULE)
        ...
        table.insert(PSTAVessel.knifeItems, FiendFolio.ITEM.COLLECTIBLE.BLOODTHIRSTY_BLADE)
        table.insert(PSTAVessel.knifeItems, FiendFolio.ITEM.COLLECTIBLE.DEVILSKNIFE)
        table.insert(PSTAVessel.knifeItems, FiendFolio.ITEM.COLLECTIBLE.KNIFE_BLOCK)

		-- Mushrooms
		table.insert(PSTAVessel.mushroomItemsQ3, FiendFolio.ITEM.COLLECTIBLE.FRAUDULENT_FUNGUS)
		table.insert(PSTAVessel.mushroomItemsQ3, FiendFolio.ITEM.COLLECTIBLE.HUITLACOCHE)
		table.insert(PSTAVessel.mushroomItemsQ3, FiendFolio.ITEM.COLLECTIBLE.LANKY_MUSHROOM)
    ...
    if Epiphany then
        ...
        PSTAVessel_addEpItem("DIMENSIONAL_KEY", {PSTAVConstellationType.COSMIC})
        PSTAVessel_addEpItem("PLASMA_BALL", {PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addEpItem("PARTY_POPPER", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addEpItem("DADS_TOOLBOX", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addEpItem("ANCIENT_ONES_MARK", {PSTAVConstellationType.OCCULT})
        PSTAVessel_addEpItem("WOODEN_STAKE", {PSTAVConstellationType.OCCULT, PSTAVConstellationType.MUNDANE})
        PSTAVessel_addEpItem("DOORKNOB", {PSTAVConstellationType.COSMIC, PSTAVConstellationType.OCCULT, PSTAVConstellationType.MUNDANE})
        PSTAVessel_addEpItem("GIANT_PUFFBALL", {PSTAVConstellationType.MUTAGENIC})
        PSTAVessel_addEpItem("LIQUID_NITROGEN", {PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addEpItem("ACTIVE_SACK", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addEpItem("RELATIVE_ROBBY", {PSTAVConstellationType.MUTAGENIC})
        PSTAVessel_addEpItem("BRAIN_IN_A_JAR", {PSTAVConstellationType.MUTAGENIC})
        PSTAVessel_addEpItem("THE_BOX", {PSTAVConstellationType.OCCULT})
        PSTAVessel_addEpItem("AIR_CONDITIONER", {PSTAVConstellationType.MUNDANE, PSTAVConstellationType.MUTAGENIC})
        PSTAVessel_addEpItem("PROMO_TOY", {PSTAVConstellationType.MUNDANE, PSTAVConstellationType.MERCANTILE})
        PSTAVessel_addEpItem("MIMICRY", {PSTAVConstellationType.MUTAGENIC})
        PSTAVessel_addEpItem("FIRE_OF_ALEXANDRIA", {PSTAVConstellationType.ELEMENTAL, PSTAVConstellationType.DEMONIC})
        PSTAVessel_addEpItem("ANKLE_WEIGHTS", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addEpItem("GEOCACHE", {PSTAVConstellationType.MERCANTILE})
    ...
    if ReverieMGO then
        ...
        table.insert(PSTAVessel.accessoryList, {item=Isaac.GetItemIdByName("Curse of the Scourge God"), sourceMod="Reverie MGO"})
        ...
        PSTAVessel_addRevItem("Curse of the Scourge God", {PSTAVConstellationType.OCCULT, PSTAVConstellationType.ELEMENTAL})
        ...
        PSTAVessel_addRevItem("Fox Mask", {PSTAVConstellationType.OCCULT})
        PSTAVessel_addRevItem("Occult Ball[0]", {PSTAVConstellationType.OCCULT})
        ...
        PSTAVessel_addRevItem("Megrez", {PSTAVConstellationType.OCCULT})
        PSTAVessel_addRevItem("Alioth", {PSTAVConstellationType.OCCULT})
        PSTAVessel_addRevItem("Haunted Scroll", {PSTAVConstellationType.OCCULT})
        PSTAVessel_addRevItem("Economic Bubble", {PSTAVConstellationType.MERCANTILE})
        PSTAVessel_addRevItem("Mirage of Flame", {PSTAVConstellationType.OCCULT})
        PSTAVessel_addRevItem("The Crown of Yamanba", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addRevItem("Return by Death", {PSTAVConstellationType.COSMIC})
        PSTAVessel_addRevItem("Dubhe", {PSTAVConstellationType.MUTAGENIC})
        PSTAVessel_addRevItem("Merak", {PSTAVConstellationType.MUTAGENIC})
        PSTAVessel_addRevItem("Phecda", {PSTAVConstellationType.MERCANTILE})
        PSTAVessel_addRevItem("Burnt Bread", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addRevItem("Boiled Egg", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addRevItem("Slipper Lobster", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addRevItem("Chocomint Ice", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addRevItem("The Lightless Shadow", {PSTAVConstellationType.OCCULT})
        PSTAVessel_addRevItem("Giant Killer", {PSTAVConstellationType.DIVINE})
        PSTAVessel_addRevItem("Dual Blade Hairpin", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addRevItem("Sight of Lamp", {PSTAVConstellationType.OCCULT})
        PSTAVessel_addRevItem("Beak of Punishment", {PSTAVConstellationType.OCCULT})
        PSTAVessel_addRevItem("Scales of Judgement", {PSTAVConstellationType.OCCULT})
        PSTAVessel_addRevItem("Toxic Wastepack", {PSTAVConstellationType.MUTAGENIC})
        PSTAVessel_addRevItem("Glitched Creature", {PSTAVConstellationType.MUTAGENIC, PSTAVConstellationType.COSMIC})
        PSTAVessel_addRevItem("Devil's Knife", {PSTAVConstellationType.DEMONIC})
        PSTAVessel_addRevItem("Infinite Spiral", {PSTAVConstellationType.COSMIC})
        PSTAVessel_addRevItem("Grudge Returning", {PSTAVConstellationType.OCCULT})
        PSTAVessel_addRevItem("Distillation Flask", {PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addRevItem("Detective Magnifying Glass", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addRevItem("Schrödinger's Guppy Doll", {PSTAVConstellationType.MERCANTILE, PSTAVConstellationType.OCCULT})
        PSTAVessel_addRevItem("Teacher Qualification Certificate", {PSTAVConstellationType.MUNDANE})
        ...
        table.insert(PSTAVessel.knifeItems, Isaac.GetItemIdByName("Dual Blade Hairpin"))
        table.insert(PSTAVessel.knifeItems, Isaac.GetItemIdByName("Devil's Knife"))
    ...
    if communityRemix then
        ...
        PSTAVessel_addCrItem("The Rot", {PSTAVConstellationType.MUTAGENIC})
        PSTAVessel_addCrItem("Polybius", {PSTAVConstellationType.OCCULT})
        PSTAVessel_addCrItem("Spider Kid", {PSTAVConstellationType.MUTAGENIC})
        PSTAVessel_addCrItem("Plague Baby", {PSTAVConstellationType.MUTAGENIC})
        PSTAVessel_addCrItem("Silly Spring", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addCrItem("Noxious Gas", {PSTAVConstellationType.MUTAGENIC, PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addCrItem("Echo Bombs", {PSTAVConstellationType.COSMIC})
        PSTAVessel_addCrItem("Drip Key", {PSTAVConstellationType.MUTAGENIC})
        PSTAVessel_addCrItem("Long Pig", {PSTAVConstellationType.OCCULT, PSTAVConstellationType.MUTAGENIC})
        PSTAVessel_addCrItem("Ballgag", {PSTAVConstellationType.DEMONIC})
        PSTAVessel_addCrItem("Chaste Heart", {PSTAVConstellationType.DIVINE})
        PSTAVessel_addCrItem("Boiled Eye", {PSTAVConstellationType.MUTAGENIC})
        PSTAVessel_addCrItem("Ku's Tail", {PSTAVConstellationType.DIVINE})
        PSTAVessel_addCrItem("Ku's Eye", {PSTAVConstellationType.DIVINE})
        PSTAVessel_addCrItem("Meathead", {PSTAVConstellationType.MUTAGENIC})
        ...
        PSTAVessel_addCrItem("Pinto Bean", {PSTAVConstellationType.MUTAGENIC, PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addCrItem("Meat Hook", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addCrItem("Brown Pony", {PSTAVConstellationType.DEMONIC, PSTAVConstellationType.MUTAGENIC})
        PSTAVessel_addCrItem("Green Pony", {PSTAVConstellationType.DEMONIC, PSTAVConstellationType.MUTAGENIC})
        PSTAVessel_addCrItem("Deck Builder", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addCrItem("Mom's Pill Case", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addCrItem("Ku's Head", {PSTAVConstellationType.DIVINE})
        PSTAVessel_addCrItem("Ku's Paw", {PSTAVConstellationType.DIVINE})
    ...
    if HeavensCall then
        ...
        PSTAVessel_addHcItem("Retrograde Mercurius", {PSTAVConstellationType.COSMIC, PSTAVConstellationType.MUTAGENIC})
        PSTAVessel_addHcItem("Retrograde Venus", {PSTAVConstellationType.COSMIC, PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addHcItem("Retrograde Terra", {PSTAVConstellationType.COSMIC, PSTAVConstellationType.DIVINE, PSTAVConstellationType.DEMONIC})
        PSTAVessel_addHcItem("Retrograde Jupiter", {PSTAVConstellationType.COSMIC, PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addHcItem("Retrograde Uranus", {PSTAVConstellationType.COSMIC, PSTAVConstellationType.MUTAGENIC})
        PSTAVessel_addHcItem("Retrograde Neptunus", {PSTAVConstellationType.COSMIC, PSTAVConstellationType.OCCULT})
        ...
        PSTAVessel_addHcItem("Lil Subnautica", {PSTAVConstellationType.COSMIC, PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addHcItem("Lil Popstar", {PSTAVConstellationType.COSMIC})
        PSTAVessel_addHcItem("​​​Lil Saturn", {PSTAVConstellationType.COSMIC})
        PSTAVessel_addHcItem("​​​Lil Titan", {PSTAVConstellationType.COSMIC, PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addHcItem("Lil Cat Planet", {PSTAVConstellationType.COSMIC, PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addHcItem("Lil Remina", {PSTAVConstellationType.COSMIC, PSTAVConstellationType.DEMONIC})
        PSTAVessel_addHcItem("Lil Ash Twin", {PSTAVConstellationType.COSMIC, PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addHcItem("Lil Ember Twin", {PSTAVConstellationType.COSMIC, PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addHcItem("Lil Timber Hearth", {PSTAVConstellationType.COSMIC})
        PSTAVessel_addHcItem("Lil Attlerock", {PSTAVConstellationType.COSMIC})
        PSTAVessel_addHcItem("Lil Brittle Hollow", {PSTAVConstellationType.COSMIC})
        PSTAVessel_addHcItem("Lil Hollow's Lantern", {PSTAVConstellationType.COSMIC})
        PSTAVessel_addHcItem("Lil Giant's Deep", {PSTAVConstellationType.COSMIC, PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addHcItem("Lil Dark Bramble", {PSTAVConstellationType.COSMIC, PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addHcItem("​​​Lil Sol", {PSTAVConstellationType.COSMIC, PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addHcItem("​​​Space Jam", {PSTAVConstellationType.COSMIC, PSTAVConstellationType.MUNDANE})
        PSTAVessel_addHcItem("​​​Asteroid Belt", {PSTAVConstellationType.COSMIC, PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addHcItem("Herald's Stallion", {PSTAVConstellationType.COSMIC, PSTAVConstellationType.MUNDANE})
        PSTAVessel_addHcItem("Panspermia", {PSTAVConstellationType.MUTAGENIC})
        PSTAVessel_addHcItem("Theia", {PSTAVConstellationType.COSMIC})
        PSTAVessel_addHcItem("Rocket Engine", {PSTAVConstellationType.COSMIC, PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addHcItem("Stellar Battery", {PSTAVConstellationType.COSMIC, PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addHcItem("Golden Telescope", {PSTAVConstellationType.COSMIC})
        PSTAVessel_addHcItem("Mochi", {PSTAVConstellationType.COSMIC, PSTAVConstellationType.OCCULT})

        PSTAVessel_addHcItem("Retrograde Mars", {PSTAVConstellationType.COSMIC, PSTAVConstellationType.DEMONIC})
        PSTAVessel_addHcItem("Retrograde Saturnus", {PSTAVConstellationType.COSMIC})
        PSTAVessel_addHcItem("​​​Quasar", {PSTAVConstellationType.COSMIC})
        PSTAVessel_addHcItem("Picatrix", {PSTAVConstellationType.COSMIC})

		-- Battery Items
        table.insert(PSTAVessel.batteryItems, Isaac.GetItemIdByName("Stellar Battery"))
    end
	...
	if ddad then
		-- Items
		local function PSTAVessel_addDDADItem(daydreamAllDayItemName, types, extraCost)
			local tmpItem = Isaac.GetItemIdByName(daydreamAllDayItemName)
			if tmpItem == -1 then
				print("[Astral Vessel] Warning: No Daydream All Day item '" .. daydreamAllDayItemName .. "' found (mod compat).")
				return
			end
			PSTAVessel:addConstellationItem(tmpItem, types, extraCost or 0, "Daydream All Day")
		end
		--PSTAVessel_addDDADItem("Tender Plan", {PSTAVConstellationType.MUNDANE}) --this adds death certificate to all pools.
		PSTAVessel_addDDADItem("*Kira*Miki Poster", {PSTAVConstellationType.ELEMENTAL})
		PSTAVessel_addDDADItem("Aldebaran", {PSTAVConstellationType.COSMIC})
		PSTAVessel_addDDADItem("Alzheimer's disease", {PSTAVConstellationType.MUTAGENIC})
		PSTAVessel_addDDADItem("Antigen of Rabies", {PSTAVConstellationType.MUTAGENIC})
		PSTAVessel_addDDADItem("Barrier of Thorns", {PSTAVConstellationType.DEMONIC, PSTAVConstellationType.OCCULT})
		PSTAVessel_addDDADItem("Battle of the Bulge", {PSTAVConstellationType.MUNDANE})
		PSTAVessel_addDDADItem("Beer on Discount", {PSTAVConstellationType.MERCANTILE})
		PSTAVessel_addDDADItem("Blasting Barrier", {PSTAVConstellationType.ELEMENTAL})
		PSTAVessel_addDDADItem("\"Brave New World\"", {PSTAVConstellationType.MUNDANE})
		PSTAVessel_addDDADItem("Briefcase MkII", {PSTAVConstellationType.MUNDANE})
		PSTAVessel_addDDADItem("Buffer Layer", {PSTAVConstellationType.MUTAGENIC})
		PSTAVessel_addDDADItem("Burst Droplets", {PSTAVConstellationType.ELEMENTAL})
		PSTAVessel_addDDADItem("Cardboard Sword", {PSTAVConstellationType.MUNDANE})
		PSTAVessel_addDDADItem("Cheap Takeaway", {PSTAVConstellationType.MUNDANE})
		PSTAVessel_addDDADItem("Climate of Corruption", {PSTAVConstellationType.MUTAGENIC})
		PSTAVessel_addDDADItem("Consumption Downgrade", {PSTAVConstellationType.MERCANTILE})
		PSTAVessel_addDDADItem("Coupon Backpack", {PSTAVConstellationType.MERCANTILE})
		PSTAVessel_addDDADItem("Crystal Crawler", {PSTAVConstellationType.MERCANTILE})
		PSTAVessel_addDDADItem("Curse Doll", {PSTAVConstellationType.DEMONIC, PSTAVConstellationType.OCCULT})
		PSTAVessel_addDDADItem("Cute Clay Houses", {PSTAVConstellationType.MUNDANE})
		PSTAVessel_addDDADItem("Cutesy Game Poster", {PSTAVConstellationType.MUNDANE})
		PSTAVessel_addDDADItem("Dark Nightmare", {PSTAVConstellationType.DEMONIC})
		PSTAVessel_addDDADItem("Design principle of Concrete Structure", {PSTAVConstellationType.ELEMENTAL, PSTAVConstellationType.MUNDANE})
		PSTAVessel_addDDADItem("Discarded Backpack", {PSTAVConstellationType.MUNDANE})
		PSTAVessel_addDDADItem("Double Reduction", {PSTAVConstellationType.MUNDANE})
		PSTAVessel_addDDADItem("Drill Helmet", {PSTAVConstellationType.MUNDANE})
		PSTAVessel_addDDADItem("Extraordinary Luck", {PSTAVConstellationType.MERCANTILE})
		PSTAVessel_addDDADItem("Fake Member Card", {PSTAVConstellationType.MERCANTILE})
		PSTAVessel_addDDADItem("Fanclub Lights", {PSTAVConstellationType.MERCANTILE})
		PSTAVessel_addDDADItem("Fearful Entity", {PSTAVConstellationType.OCCULT, PSTAVConstellationType.ELEMENTAL})
		PSTAVessel_addDDADItem("Festive Winds", {PSTAVConstellationType.DIVINE})
		PSTAVessel_addDDADItem("Fire of the Hell", {PSTAVConstellationType.OCCULT, PSTAVConstellationType.DEMONIC})
		PSTAVessel_addDDADItem("Flash Shield", {PSTAVConstellationType.MUNDANE})
		PSTAVessel_addDDADItem("Flint and Steel", {PSTAVConstellationType.MUNDANE, PSTAVConstellationType.ELEMENTAL})
		PSTAVessel_addDDADItem("Focus Talisman", {PSTAVConstellationType.MUNDANE})
		PSTAVessel_addDDADItem("Frozen Bombs", {PSTAVConstellationType.ELEMENTAL})
		PSTAVessel_addDDADItem("Ghost Rider", {PSTAVConstellationType.ELEMENTAL})
		PSTAVessel_addDDADItem("Golden Finger", {PSTAVConstellationType.MERCANTILE})
		PSTAVessel_addDDADItem("Grandfather Paradox", {PSTAVConstellationType.COSMIC})
		PSTAVessel_addDDADItem("Greedy Blood Heart", {PSTAVConstellationType.MERCANTILE})
		PSTAVessel_addDDADItem("Heavenly Delight", {PSTAVConstellationType.ELEMENTAL, PSTAVConstellationType.MERCANTILE})
		PSTAVessel_addDDADItem("Holo-Plant", {PSTAVConstellationType.ELEMENTAL})
		PSTAVessel_addDDADItem("Horologium", {PSTAVConstellationType.COSMIC})
		PSTAVessel_addDDADItem("Insurance Document", {PSTAVConstellationType.MERCANTILE, PSTAVConstellationType.MUNDANE})
		PSTAVessel_addDDADItem("Invisibility Cloak", {PSTAVConstellationType.MUNDANE})
		PSTAVessel_addDDADItem("Isaac's Alphabet", {PSTAVConstellationType.MUNDANE})
		PSTAVessel_addDDADItem("Joint Effusion", {PSTAVConstellationType.MUTAGENIC})
		PSTAVessel_addDDADItem("Joker Cyclone", {PSTAVConstellationType.MUNDANE})
		PSTAVessel_addDDADItem("Lancet", {PSTAVConstellationType.MUTAGENIC, PSTAVConstellationType.MUNDANE})
		PSTAVessel_addDDADItem("Life and Death Limit", {PSTAVConstellationType.DEMONIC})
		PSTAVessel_addDDADItem("Maggot Nest", {PSTAVConstellationType.MUTAGENIC})
		PSTAVessel_addDDADItem("Magic Hurricane", {PSTAVConstellationType.DIVINE})
		PSTAVessel_addDDADItem("Meat Lantern", {PSTAVConstellationType.MUTAGENIC})
		PSTAVessel_addDDADItem("Mom's Earrings", {PSTAVConstellationType.MUNDANE})
		PSTAVessel_addDDADItem("Money Worship", {PSTAVConstellationType.MERCANTILE})
		PSTAVessel_addDDADItem("Mulan Tea", {PSTAVConstellationType.MUNDANE})
		PSTAVessel_addDDADItem("Nameless Bouquet", {PSTAVConstellationType.ELEMENTAL})
		PSTAVessel_addDDADItem("Nanodust", {PSTAVConstellationType.MUNDANE})
		PSTAVessel_addDDADItem("Non-responsible Aggregates", {PSTAVConstellationType.MERCANTILE})
		PSTAVessel_addDDADItem("Objectified Anger", {PSTAVConstellationType.DEMONIC, PSTAVConstellationType.ELEMENTAL})
		PSTAVessel_addDDADItem("Offspring of Evolution", {PSTAVConstellationType.ELEMENTAL})
		PSTAVessel_addDDADItem("Old Calculator", {PSTAVConstellationType.MUNDANE, PSTAVConstellationType.MERCANTILE})
		PSTAVessel_addDDADItem("Overflow Counter", {PSTAVConstellationType.ELEMENTAL})
		PSTAVessel_addDDADItem("Overgild Wrench", {PSTAVConstellationType.MERCANTILE})
		PSTAVessel_addDDADItem("Overload™ Shield", {PSTAVConstellationType.MUNDANE})
		PSTAVessel_addDDADItem("Paper Lantern", {PSTAVConstellationType.MUNDANE})
		PSTAVessel_addDDADItem("Peace Dove", {PSTAVConstellationType.DIVINE})
		PSTAVessel_addDDADItem("Power Outage", {PSTAVConstellationType.MUNDANE})
		PSTAVessel_addDDADItem("Presumption of Guilt", {PSTAVConstellationType.MERCANTILE, PSTAVConstellationType.DEMONIC})
		PSTAVessel_addDDADItem("Pride", {PSTAVConstellationType.DEMONIC})
		PSTAVessel_addDDADItem("Protanopia", {PSTAVConstellationType.MUTAGENIC})
		PSTAVessel_addDDADItem("Red-satin Spear", {PSTAVConstellationType.DIVINE})
		PSTAVessel_addDDADItem("Rocket Backpack", {PSTAVConstellationType.ELEMENTAL})
		PSTAVessel_addDDADItem("Runner", {PSTAVConstellationType.MUNDANE})
		PSTAVessel_addDDADItem("Shackles", {PSTAVConstellationType.ELEMENTAL})
		PSTAVessel_addDDADItem("Shadow Binding", {PSTAVConstellationType.DEMONIC, PSTAVConstellationType.ELEMENTAL})
		PSTAVessel_addDDADItem("Shoulder Massager", {PSTAVConstellationType.MUNDANE})
		PSTAVessel_addDDADItem("Shredded Cards", {PSTAVConstellationType.OCCULT})
		PSTAVessel_addDDADItem("Signal Jammers", {PSTAVConstellationType.MUNDANE})
		PSTAVessel_addDDADItem("Singularity Collapse", {PSTAVConstellationType.COSMIC, PSTAVConstellationType.DEMONIC})
		PSTAVessel_addDDADItem("Soul Blade", {PSTAVConstellationType.OCCULT, PSTAVConstellationType.MUNDANE})
		PSTAVessel_addDDADItem("Source of Fear", {PSTAVConstellationType.DEMONIC})
		PSTAVessel_addDDADItem("Stale Burger", {PSTAVConstellationType.MUTAGENIC})
		PSTAVessel_addDDADItem("Submission Flag", {PSTAVConstellationType.MUNDANE})
		PSTAVessel_addDDADItem("Tainted Punching Bag", {PSTAVConstellationType.MUTAGENIC})
		PSTAVessel_addDDADItem("The Endless Wheel of Fortune", {PSTAVConstellationType.MERCANTILE})
		PSTAVessel_addDDADItem("Throat of Siren", {PSTAVConstellationType.DEMONIC})
		PSTAVessel_addDDADItem("Timecard", {PSTAVConstellationType.MUNDANE, PSTAVConstellationType.MERCANTILE})
		PSTAVessel_addDDADItem("Trader Llama", {PSTAVConstellationType.MUTAGENIC})
		PSTAVessel_addDDADItem("Trap Bomb", {PSTAVConstellationType.MUNDANE})
		PSTAVessel_addDDADItem("Uncertified Exoskeleton", {PSTAVConstellationType.COSMIC})
		PSTAVessel_addDDADItem("Unstable Options", {PSTAVConstellationType.MERCANTILE})
    ...
    if _wakaba then
        ...
        PSTAVessel_addPNWItem("DEJA_VU", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addPNWItem("REVENGE_FRUIT", {PSTAVConstellationType.DEMONIC})
        PSTAVessel_addPNWItem("SECRET_CARD", {PSTAVConstellationType.MERCANTILE})
        PSTAVessel_addPNWItem("RETURN_POSTAGE", {PSTAVConstellationType.OCCULT})
        PSTAVessel_addPNWItem("BOOK_OF_THE_FALLEN", {PSTAVConstellationType.DEMONIC})
        PSTAVessel_addPNWItem("BOOK_OF_THE_GOD", {PSTAVConstellationType.DIVINE})
        PSTAVessel_addPNWItem("BOOK_OF_SHIORI", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addPNWItem("LUNAR_STONE", {PSTAVConstellationType.COSMIC})
        PSTAVessel_addPNWItem("ELIXIR_OF_LIFE", {PSTAVConstellationType.OCCULT})
        PSTAVessel_addPNWItem("NASA_LOVER", {PSTAVConstellationType.ELEMENTAL, PSTAVConstellationType.COSMIC})
        PSTAVessel_addPNWItem("MAGMA_BLADE", {PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addPNWItem("LUNAR_DAMOCLES", {PSTAVConstellationType.COSMIC})
        PSTAVessel_addPNWItem("VENOM_INCANTATION", {PSTAVConstellationType.MUTAGENIC, PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addPNWItem("FIREFLY_LIGHTER", {PSTAVConstellationType.DIVINE})
        PSTAVessel_addPNWItem("DOUBLE_INVADER", {PSTAVConstellationType.DIVINE, PSTAVConstellationType.DEMONIC})
        PSTAVessel_addPNWItem("ANTI_BALANCE", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addPNWItem("BLACK_BEAN_MOCHI", {PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addPNWItem("RIRAS_SWIMSUIT", {PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addPNWItem("SAKURA_MONT_BLANC", {PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addPNWItem("RIRAS_BENTO", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addPNWItem("CHEWY_ROLLY_CAKE", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addPNWItem("RIRAS_BANDAGE", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addPNWItem("LIL_RIRA", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addPNWItem("SAKURA_CAPSULE", {PSTAVConstellationType.DIVINE})
        PSTAVessel_addPNWItem("SUCCUBUS_BLANKET", {PSTAVConstellationType.DEMONIC})
        PSTAVessel_addPNWItem("WAKABAS_HAIRPIN", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addPNWItem("PLUMY", {PSTAVConstellationType.MUTAGENIC})
        PSTAVessel_addPNWItem("LIL_MAO", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addPNWItem("RICHERS_NECKLACE", {PSTAVConstellationType.DIVINE})
        PSTAVessel_addPNWItem("BUBBLE_BOMBS", {PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addPNWItem("KYOUTAROU_LOVER", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addPNWItem("CROSS_BOMB", {PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addPNWItem("CURSE_OF_THE_TOWER_2", {PSTAVConstellationType.OCCULT})
        PSTAVessel_addPNWItem("RICHERS_BRA", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addPNWItem("CURSE_OF_THE_TOWER_2", {PSTAVConstellationType.OCCULT})
        PSTAVessel_addPNWItem("ONSEN_TOWEL", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addPNWItem("CRISIS_BOOST", {PSTAVConstellationType.MUNDANE})

        PSTAVessel_addPNWItem("D6_CHAOS", {PSTAVConstellationType.MERCANTILE, PSTAVConstellationType.COSMIC})
        PSTAVessel_addPNWItem("MAIJIMA_MYTHOLOGY", {PSTAVConstellationType.OCCULT, PSTAVConstellationType.MUNDANE})
        PSTAVessel_addPNWItem("BOOK_OF_FORGOTTEN", {PSTAVConstellationType.OCCULT})
        PSTAVessel_addPNWItem("BOOK_OF_FOCUS", {PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addPNWItem("DECK_OF_RUNES", {PSTAVConstellationType.COSMIC})
        PSTAVessel_addPNWItem("GRIMREAPER_DEFENDER", {PSTAVConstellationType.OCCULT})
        PSTAVessel_addPNWItem("BOOK_OF_TRAUMA", {PSTAVConstellationType.OCCULT})
        PSTAVessel_addPNWItem("FLASH_SHIFT", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addPNWItem("SWEETS_CATALOG", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addPNWItem("POWER_BOMB", {PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addPNWItem("PHANTOM_CLOAK", {PSTAVConstellationType.OCCULT})
        PSTAVessel_addPNWItem("QUESTION_BLOCK", {PSTAVConstellationType.MERCANTILE, PSTAVConstellationType.MUNDANE})
        PSTAVessel_addPNWItem("BEETLEJUICE", {PSTAVConstellationType.OCCULT})
        PSTAVessel_addPNWItem("CUNNING_PAPER", {PSTAVConstellationType.MUNDANE, PSTAVConstellationType.OCCULT})
        PSTAVessel_addPNWItem("SELF_BURNING", {PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addPNWItem("WATER_FLAME", {PSTAVConstellationType.ELEMENTAL, PSTAVConstellationType.OCCULT})
        PSTAVessel_addPNWItem("NERF_GUN", {PSTAVConstellationType.MUNDANE, PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addPNWItem("RIRAS_COAT", {PSTAVConstellationType.OCCULT})
        PSTAVessel_addPNWItem("SECRET_DOOR", {PSTAVConstellationType.MUNDANE, PSTAVConstellationType.OCCULT})
        PSTAVessel_addPNWItem("RIRAS_UNIFORM", {PSTAVConstellationType.MUNDANE, PSTAVConstellationType.DIVINE})
        PSTAVessel_addPNWItem("POW_BLOCK", {PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addPNWItem("MOD_BLOCK", {PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addPNWItem("RABBEY_WARD", {PSTAVConstellationType.DIVINE})
        PSTAVessel_addPNWItem("ISEKAI_DEFINITION", {PSTAVConstellationType.MUTAGENIC})
        PSTAVessel_addPNWItem("BALANCE", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addPNWItem("RICHERS_FLIPPER", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addPNWItem("SYRUP", {PSTAVConstellationType.MUTAGENIC})
	...
	if EdithRestored then
		-- items
		local function PSTAVessel_addRedithItem(redithItemName, types, extraCost)
			local tmpItem = Isaac.GetItemIdByName(redithItemName)
			if tmpItem == -1 then
				print("[Astral Vessel] Warning: No Restored Edith item '" .. redithItemName .. "' found (mod compat).")
				return
			end
			PSTAVessel:addConstellationItem(tmpItem, types, extraCost or 0, "Restored Edith")
		end
		PSTAVessel_addRedithItem("Lithium Salts", {PSTAVConstellationType.MUNDANE, PSTAVConstellationType.MUTAGENIC})
		PSTAVessel_addRedithItem("​Sodom", {PSTAVConstellationType.DEMONIC, PSTAVConstellationType.ELEMENTAL})
		PSTAVessel_addRedithItem("Blasting Boots", {PSTAVConstellationType.ELEMENTAL})
		PSTAVessel_addRedithItem("​Thunder Bombs", {PSTAVConstellationType.ELEMENTAL})
		PSTAVessel_addRedithItem("​Salty Baby", {PSTAVConstellationType.ELEMENTAL})
		PSTAVessel_addRedithItem("​Salt Pawns", {PSTAVConstellationType.ELEMENTAL})
		PSTAVessel_addRedithItem("​Red Hood", {PSTAVConstellationType.OCCULT})
		PSTAVessel_addRedithItem("Shrapnel Bombs", {PSTAVConstellationType.ELEMENTAL})
		PSTAVessel_addRedithItem("​Peppermint", {PSTAVConstellationType.ELEMENTAL})

		PSTAVessel_addRedithItem("​Salt Shaker", {PSTAVConstellationType.ELEMENTAL, PSTAVConstellationType.OCCULT})
		PSTAVessel_addRedithItem("Gorgon Mask", {PSTAVConstellationType.OCCULT})
	end
