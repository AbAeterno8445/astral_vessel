...
function PSTAVessel:initModCompat()
    ...
    if yandereWaifu then -- yes that is really what it's called - wooky
        ...
        PSTAVessel_addRbItem("Love Deluxe", {PSTAVConstellationType.OCCULT, PSTAVConstellationType.MUTAGENIC})
        PSTAVessel_addRbItem("Great Pheonix", {PSTAVConstellationType.MUTAGENIC})
        PSTAVessel_addRbItem("Finger Finger", {PSTAVConstellationType.MUTAGENIC})
        PSTAVessel_addRbItem("Moriah Diary", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addRbItem("Love = Power", {PSTAVConstellationType.MUTAGENIC, PSTAVConstellationType.MUNDANE})
        PSTAVessel_addRbItem("Cursed Spoon", {PSTAVConstellationType.OCCULT})
        PSTAVessel_addRbItem("Snap!", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addRbItem("A Beautiful Grave", {PSTAVConstellationType.OCCULT})
        PSTAVessel_addRbItem("Eggshell Walk", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addRbItem("Oversized Sweater", {PSTAVConstellationType.MUNDANE, PSTAVConstellationType.MUTAGENIC})
        PSTAVessel_addRbItem("Eyes of the Dead", {PSTAVConstellationType.MUTAGENIC, PSTAVConstellationType.OCCULT})
        PSTAVessel_addRbItem("Psoriasis", {PSTAVConstellationType.MUTAGENIC})
        PSTAVessel_addRbItem("Tech Hz", {PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addRbItem("Skimmed Milk", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addRbItem("Haphephobic Bombs", {PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addRbItem("Pencil Sharpener", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addRbItem("Narcolepsy", {PSTAVConstellationType.MUTAGENIC})
        PSTAVessel_addRbItem("Angel's Morningstar", {PSTAVConstellationType.DIVINE})
        PSTAVessel_addRbItem("Miraculous Womb", {PSTAVConstellationType.MUTAGENIC, PSTAVConstellationType.DIVINE})
        PSTAVessel_addRbItem("Eternal Bond", {PSTAVConstellationType.DIVINE})
        PSTAVessel_addRbItem("Cheesy Pizza", {PSTAVConstellationType.MUNDANE, PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addRbItem("Boba Tea", {PSTAVConstellationType.MUNDANE, PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addRbItem("Fenrir's Eyes", {PSTAVConstellationType.MUTAGENIC, PSTAVConstellationType.DEMONIC})
        PSTAVessel_addRbItem("Fenrir's Tooth", {PSTAVConstellationType.MUTAGENIC, PSTAVConstellationType.DEMONIC})
        PSTAVessel_addRbItem("Fenrir's Head", {PSTAVConstellationType.MUTAGENIC, PSTAVConstellationType.DEMONIC})
        PSTAVessel_addRbItem("Fenrir's Leash", {PSTAVConstellationType.OCCULT, PSTAVConstellationType.DEMONIC})
        PSTAVessel_addRbItem("Heartaches...", {PSTAVConstellationType.OCCULT, PSTAVConstellationType.COSMIC})
        PSTAVessel_addRbItem("Silphium", {PSTAVConstellationType.DIVINE})
        PSTAVessel_addRbItem("Underpay", {PSTAVConstellationType.MERCANTILE})
        PSTAVessel_addRbItem("Milk Wine", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addRbItem("Jacob's Tears", {PSTAVConstellationType.MUNDANE, PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addRbItem("Silent Treatment", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addRbItem("Silencer", {PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addRbItem("Full Fat Milk", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addRbItem("Cutie Patootie", {PSTAVConstellationType.OCCULT, PSTAVConstellationType.ELEMENTAL})
        
        PSTAVessel_addRbItem("Doorstopper", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addRbItem("The Shining", {PSTAVConstellationType.DEMONIC})
        PSTAVessel_addRbItem("Defuse = Rewards", {PSTAVConstellationType.MUTAGENIC})
        PSTAVessel_addRbItem("Typical Rom-Com", {PSTAVConstellationType.MUNDANE, PSTAVConstellationType.ELEMENTAL})
        PSTAVessel_addRbItem("Dice of Fate", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addRbItem("Notebook of the Dead", {PSTAVConstellationType.OCCULT})
        PSTAVessel_addRbItem("Hearts and Crafts", {PSTAVConstellationType.MUNDANE})
        PSTAVessel_addRbItem("Jumpy Dumpty", {PSTAVConstellationType.ELEMENTAL})
